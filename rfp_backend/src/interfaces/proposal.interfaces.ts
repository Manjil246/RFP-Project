...
export interface IProposalRepository {
  ...
  createProposalLineItems(lineItems: NewProposalLineItem[]): Promise<ProposalLineItem[]>;
  getProposalById(id: string): Promise<Proposal | null>;
  getProposalsByRFPId(rfpId: string): Promise<Proposal[]>;
  getAllProposals(): Promise<Proposal[]>;
  getProposalWithLineItems(id: string): Promise<(Proposal & { lineItems: ProposalLineItem[] }) | null>;
  getProposalsByRFPIdWithLineItems(rfpId: string): Promise<(Proposal & { lineItems: ProposalLineItem[] })[]>;
...
export interface IProposalService {
  ...
  getProposalById(id: string): Promise<(Proposal & { lineItems: ProposalLineItem[] }) | null>;
  getProposalsByRFPId(rfpId: string): Promise<(Proposal & { lineItems: ProposalLineItem[] })[]>;
